...
public class AviatorTestContainer extends TestContainer {

    public AviatorTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/aviator/app.properties",
    ...
    public static class Common extends AviatorTestContainer {

        public static final AviatorTestContainer.Common INSTANCE = new AviatorTestContainer.Common();
